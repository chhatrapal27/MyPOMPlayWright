...
Locator:  locator('#link-to-download')
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('#link-to-download')
    13 × locator resolved to <a id="link-to-download" download="Lambdainfo.txt">Download</a>
...
- main:
  - heading "File Download Demo" [level=1]
  - paragraph: Data entered in the below textarea will be download with file name 'Lambdainfo.txt'.
  - text: "Enter Data:"
  - textbox: This is a test file for download
  - text: 500 characters remaining
